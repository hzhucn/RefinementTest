...
class FCN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.deconv2 = nn.ConvTranspose2d(self.num_classes, self.num_classes, 3, stride=2, padding=1, output_padding=1)

        self.deconv3 = nn.ConvTranspose2d(self.num_classes, self.num_classes, 3, stride=2, padding=1, output_padding=1)
