...
class CSDataSet(data.Dataset):
    def __init__(self, root, split="train", img_transform=None, label_transform=None,
                    label_2_transform=None, label_4_transform=None):
        self.root = root
        self.split = split
        ...
        self.label_2_transform = label_2_transform
        self.label_4_transform = label_4_transform
    ...
    def __getitem__(self, index):
        ...
        if self.label_2_transform is not None:
            label_o_2 = self.label_2_transform(label)
            # label_h = self.label_transform(self.h_flip(label))
            # label_v = self.label_transform(self.v_flip(label))
            labels_2 = label_o_2
        else:
        ...
        if self.label_4_transform is not None:
            label_o_4 = self.label_4_transform(label)
            # label_h = self.label_transform(self.h_flip(label))
            # label_v = self.label_transform(self.v_flip(label))
            labels_4 = label_o_4
        else:
       ...
       # print np.array(labels)
        return imgs, labels, labels_2, labels_4
